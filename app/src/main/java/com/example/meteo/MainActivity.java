                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            double longt = coord.getDouble("lon");
                            double latt = (coord.getDouble("lat"));
                            btn_map.setOnClickListener(view -> {
                                Intent intent = new Intent(getApplicationContext(), MapsActivity.class);
                                Bundle b = new Bundle();
                                b.putString("name", String.valueOf(ville.getText().toString()));
                                b.putDouble("longitude", longt);
                                b.putDouble("latitude", latt);
                                intent.putExtras(b);
...
//                            double longt= (double) main.get("longitude");
//                            double latt= (double) main.get("latitude");
